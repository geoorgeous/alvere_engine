...
class S_DirectionFromMovement : public alvere::QueryUpdatedSystem<C_Direction, C_Movement>
{
public:

	void Update(float deltaTime, C_Direction & direction, C_Movement & movement)
	{
