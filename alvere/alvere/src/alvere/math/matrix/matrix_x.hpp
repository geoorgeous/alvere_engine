...
namespace alvere
{
	...
	struct Matrix
	{
		 ...
		 * \warning This function performs no array-bounds checking. the passed index must be [0 alvere/math Minor - 1] where Minor is the number of rows.
		 */
		 ...
		 * \warning This function performs no array-bounds checking. the passed index must be [0 alvere/math Major - 1] where Major is the number of columns.
		 */
